...
draft: false
image: stocks.jpeg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
knitr::include_graphics("/img/stocks.jpeg",error=FALSE)
```
